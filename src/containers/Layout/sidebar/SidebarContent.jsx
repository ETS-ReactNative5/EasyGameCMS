    ...
    return (
      <div className='sidebar__content'>
        <ul className='sidebar__block'>
          ...
          <SidebarCategory title='Leaderboard' icon='rocket'>
            <SidebarLink title='Survival' route='/leaderboard/survival' onClick={this.hideSidebar} />
            <SidebarLink title='Boss Score' route='/leaderboard/bossscore' onClick={this.hideSidebar} />
          </SidebarCategory>
          ...
          <SidebarCategory title='Users' icon='user'>
            ...
            <SidebarLink title='User Data' route='/users/profile' onClick={this.hideSidebar} />
            <SidebarLink title='User Manager' route='/users/userfunction' onClick={this.hideSidebar} />
            <SidebarLink title='List Hack' route='/users/listhack' onClick={this.hideSidebar} />
          </SidebarCategory>
